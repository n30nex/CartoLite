...
- One vanilla TypeScript page uses MapLibre GL JS for vector geography, optional clusters and terrain, packet-coloured bounded heat, exact MeshMapper regions, a camera-stable WebGL layer containing every individual route, and native selected-route glow. Canvas2D is reserved for transient packet motion.
...
See [Architecture](docs/architecture.md), [Android app](docs/android.md), [data sources](docs/data-sources.md), [public API](docs/public-api.md), [browser and app privacy](docs/privacy.md), [sound and animation](docs/sound-and-animation.md), [deployment](docs/deployment.md), and [operations](docs/operations.md).
