...
- One vanilla TypeScript multi-page build serves the MapLibre map and a lazy-loaded Labs shell from the same binary. Labs uses bounded Canvas2D experiments plus one WebGL2 aurora with a Canvas fallback; it shares the existing public feed and sound engine.
...
See [Architecture](docs/architecture.md), [Labs](docs/labs.md), [Android app](docs/android.md), [data sources](docs/data-sources.md), [public API](docs/public-api.md), [browser and app privacy](docs/privacy.md), [sound and animation](docs/sound-and-animation.md), [deployment](docs/deployment.md), and [operations](docs/operations.md).
