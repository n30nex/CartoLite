...
- One vanilla TypeScript page uses MapLibre GL JS for vector geography, clustered nodes, bounded heat, geographically anchored route trunks and individual route lines, plus exact selected-route interaction. Dedicated Canvas2D layers keep exact regional boundaries and labels and transient packet motion responsive.
